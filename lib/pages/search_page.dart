...
import 'package:readiverse_app/helpers/components/search_page/book_card_widget.dart';
import 'package:readiverse_app/helpers/components/search_page/searchbar_widget.dart';
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return GestureDetector(
                        onTap: () {
                          Get.toNamed(
                            '/detailBookPage', 
                            arguments: category.books[index]
                          );
                        },
                        child: Stack(
                          children: [
